...
public class BestDealsRecyclerViewAdapter extends RecyclerView.Adapter<BestDealsRecyclerViewAdapter.BestDealsViewHolder> {
    private static final String TAG = "BestDealsRecyclerViewAd";
...
//    private static final DecimalFormat df = new DecimalFormat("0.00");
    ...
    public BestDealsRecyclerViewAdapter(Context context) {
        Log.i(TAG, "BestDealsRecyclerViewAdapter: Context Based Constructor fired!");
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull BestDealsRecyclerViewAdapter.BestDealsViewHolder holder, int position) {
    ...
    public void setProdIdOrderQtyHashMap(HashMap<Integer, Integer> prodIdOrderQtyHashMap) {
        ...
        /*USING THIS NULL CHECK TO CLEAR THE CART DATA OF BEST DEALS RECYCLERVIEWADAPTER.*/
        ...
        if (prodIdOrderQtyHashMap.size() != 0) {
            ...
            Log.i(TAG, "setProdIdOrderQtyHashMap: Not notifying the BestDealsAdapter for prodIdQtyHashMap = 0.");
        }
    }
